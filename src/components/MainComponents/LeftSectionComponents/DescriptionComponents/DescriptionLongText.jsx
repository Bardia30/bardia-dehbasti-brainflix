...
export default function DescriptionLongText() {
    return (
        <p className='description__long-text'>On a gusty day in Southern Utah, a group of 25 daring mountain bikers blew the doors off what is possible
